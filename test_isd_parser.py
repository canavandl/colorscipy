...
class TestMatchBatchId(unittest.TestCase):
    ...
    def test_match_batch_id(self):
        ...
        self.assertEqual(isd_parser.match_batch_id(isd_chunk), 'EE02017-1-D')
...
class TestMatchTimestamp(unittest.TestCase):
    ...
    def test_match_timestamp(self):
        isd_chuck = '[General Information]\n' \
                    ...
                    'Time=10:50:28 AM\n' \
                    'User=instruments\n'
        self.assertEqual(isd_parser.match_timestamp(isd_chuck), ('6/4/2014', '10:50:28 AM'))
...
class TestConvertISDTimestampToUTC(unittest.TestCase):
    ...
    def test_convert_isd_timestamp_to_utc(self):
        ...
        self.assertEqual(isd_parser.convert_isd_timestamp_to_utc(*isd_timestamp), 1401879028)
...
class TestMatchData(unittest.TestCase):
    ...
    def test_match_data(self):
        ...
        self.assertTrue(np.array_equal(isd_parser.match_data(isd_chunk), demo_spectra))
